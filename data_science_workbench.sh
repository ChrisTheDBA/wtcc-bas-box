...
read -p "Password for $rstudioUser: " rstudioPassword
read -p "Confirm password: " rstudioPassword_confirm
...
sudo sed -i 's@##R_LIBS_USER@R_LIBS_USER@' /usr/lib/R/etc/Renviron
sudo wget https://download2.rstudio.org/rstudio-server-0.99.902-amd64.deb
...
echo "###################################################"
echo ""
sudo wget https://3230d63b5fc54e62148e-c95ac804525aac4b6dba79b00b39d1d3.ssl.cf1.rackcdn.com/Anaconda3-4.0.0-Linux-x86_64.sh --no-check-certificate
...
sudo wget http://download3.rstudio.org/ubuntu-12.04/x86_64/shiny-server-1.4.2.786-amd64.deb
sudo gdebi -n shiny-server-1.4.2.786-amd64.deb
echo ""
echo ""
